...
const CreatePostLayout: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      await axios.post(
        "https://tech-challenge-blog.onrender.com/posts/",
        {
          title: titulo,
          content: conteudo,
          author: autor,
      ...
      setSnackbar({
        open: true,
        message: "Ops! Erro ao realizar cadastro do post. Tente novamente.",
        severity: "error"
      });
    }
  };
  ...
  useEffect(() => {
    ...
    if (isTeacher === false) {
      setSnackbar({
        open: true,
        message: "Esta página é somente para professores!",
        severity: "error"
      });
      setTimeout(() => {
        router.push("/");
